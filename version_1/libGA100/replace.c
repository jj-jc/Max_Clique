...
/*----------------------------------------------------------------------------
| Pick best 2 of 4 chromosomes (original version)
----------------------------------------------------------------------------*/
RE_pick_best_old(ga_info, p1, p2, c1, c2)
   GA_Info_Ptr ga_info;
   Chrom_Ptr   p1, p2, c1, c2;
{
   int xp1, xp2;
...
/*----------------------------------------------------------------------------
| Pick best of the two children and the best of
| the remaining three  (our version)
----------------------------------------------------------------------------*/
RE_pick_best(ga_info, p1, p2, c1, c2)
   GA_Info_Ptr ga_info;
   Chrom_Ptr   p1, p2, c1, c2;
